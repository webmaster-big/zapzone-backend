...
<head>
    <meta charset="UTF-8">
    <title>Your Zap Zone Account</title>
</head>
        ...
        <tr>
            <td style="padding:24px;">
                ...
                <p>
                    ...
                    so you can manage your membership online &mdash; view your pass, check usage,
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;border-collapse:collapse;margin:16px 0;">
                    <tr>
                        <td style="padding:8px 12px;background:#f1f3f7;border:1px solid #e3e6ec;width:170px;"><strong>Email (login)</strong></td>
                        <td style="padding:8px 12px;border:1px solid #e3e6ec;">{{ $customer->email }}</td>
                    </tr>
                    <tr>
