                    ...
                    <tr>
                        <td>
                            @if(isset($company) && $company && $company->logo_path)
                                ...
                                <h2 style="color: #111827; font-size: 20px; font-weight: 600; margin: 0 0 16px 0; letter-spacing: -0.01em; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif;">Welcome to {{ $company->company_name }}!</h2>
                            @else
