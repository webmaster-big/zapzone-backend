...
<head>
    ...
    <title>Call to Book Requested</title>
</head>
        ...
        <tr>
            <td align="center">
                <table width="520" cellpadding="0" cellspacing="0" border="0" style="max-width: 520px; width: 100%;">
                    <tr>
                        <td style="text-align: center; background-color: #0f766e; color: #ffffff; padding: 24px 32px; border-radius: 8px 8px 0 0;">
                            ...
                            @endif
                            <h1 style="margin: 0 0 8px 0; padding: 0; font-size: 20px; font-weight: 600; color: #ffffff;">A customer wants to book by phone</h1>
                    ...
                    <tr>
                        <td style="background-color: #ffffff; padding: 32px; border-radius: 0 0 8px 8px; border: 1px solid #e5e7eb; border-top: none;">
                            <p style="margin: 0 0 24px 0; padding: 0; font-size: 14px; line-height: 1.6; color: #4b5563;">
                                They were looking at an item with no online schedule and asked to be contacted through the Call to Book form.
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #f9fafb; border-radius: 6px; border: 1px solid #e5e7eb; margin: 0 0 24px 0;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 10px 16px; font-size: 14px; color: #111827; font-weight: 600; {{ $concern->email ? 'border-bottom: 1px solid #e5e7eb;' : '' }}">
                                        <a href="tel:{{ $concern->phone }}" style="color: #0f766e; text-decoration: none;">{{ $concern->phone }}</a>
                                    </td>
                                </tr>
                                @if($concern->email)
                                <tr>
                                    ...
                                    <td style="padding: 10px 16px; font-size: 14px; color: #111827;">
                                        <a href="mailto:{{ $concern->email }}" style="color: #0f766e; text-decoration: none;">{{ $concern->email }}</a>
                                    </td>
                                </tr>
                                @endif
                            </table>

                            <h3 style="margin: 0 0 12px 0; padding: 0; font-size: 16px; font-weight: 600; color: #111827;">What they want to book</h3>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #f9fafb; border-radius: 6px; border: 1px solid #e5e7eb; margin: 0 0 24px 0;">
                                <tr>
                                    <td style="padding: 10px 16px; font-size: 14px; color: #6b7280;">Item</td>
                                    <td style="padding: 10px 16px; font-size: 14px; color: #111827;">{{ $concern->entity_name ?: 'Not chosen yet' }}</td>
                                </tr>
                            </table>

                            @if($concern->message)
                                <h3 style="margin: 0 0 12px 0; padding: 0; font-size: 16px; font-weight: 600; color: #111827;">In their words</h3>
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #f0fdfa; border-radius: 6px; border: 1px solid #5eead4; margin: 0 0 24px 0;">
                                    <tr>
                                        <td style="padding: 16px; font-size: 14px; line-height: 1.6; color: #134e4a;">{{ $concern->message }}</td>
                                    </tr>
                                </table>
                            @endif
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="center" style="padding: 8px 0 0 0;">
                                        <a href="{{ $reviewUrl }}" style="display: inline-block; background-color: #0f766e; color: #ffffff; text-decoration: none; padding: 12px 28px; border-radius: 6px; font-size: 14px; font-weight: 600;">Open in ZapZone</a>
                                    </td>
                                </tr>
                            </table>
