    ...
    public static function getDefaultDefinitions(): array
    {
        ...
        return [
            ...
            [
                ...
                'recipient_types' => [$C],
                'custom_phones' => [],
                'body' => '{{company_name}}: {{attraction_name}} confirmed! Qty {{purchase_quantity}}, total {{purchase_total}}. Ref {{purchase_reference}}. Show at entry. {{location_phone}} {{waiver_line}}',
            ],
            [
            ...
            [
                ...
                'recipient_types' => [$C],
                'custom_phones' => [],
                'body' => '{{company_name}}: you\'re going to {{event_name}}! {{event_date}} {{event_time}}. Qty {{event_quantity}}. Ref {{event_reference}}. Balance {{event_balance}}. {{location_phone}} {{waiver_line}}',
            ],
            [
            ...
            // ---- Waivers ----
            [
                'default_key' => SmsNotification::DEFAULT_WAIVER_STAFF_SENT_CUSTOMER,
                'name' => 'Waiver Link Sent (Customer)',
                'description' => 'Sent with a link to complete a waiver before the visit.',
                'trigger_type' => SmsNotification::TRIGGER_WAIVER_STAFF_SENT,
                'entity_type' => SmsNotification::ENTITY_WAIVER,
                'entity_ids' => [],
                'recipient_types' => [$C],
                'custom_phones' => [],
                'body' => '{{company_name}}: please complete your waiver before your visit. It only takes a minute: {{waiver_link}}',
            ],
            [
                'default_key' => SmsNotification::DEFAULT_WAIVER_REMINDER_CUSTOMER,
                'name' => 'Waiver Reminder (Customer)',
                'description' => 'Sent when a waiver is still incomplete within the reminder window before the visit.',
                'trigger_type' => SmsNotification::TRIGGER_WAIVER_REMINDER,
                'entity_type' => SmsNotification::ENTITY_WAIVER,
                'entity_ids' => [],
                'recipient_types' => [$C],
                'custom_phones' => [],
                'body' => '{{company_name}} reminder: your visit is coming up. Please complete your waiver before you arrive: {{waiver_link}}',
            ],
            [
                'default_key' => SmsNotification::DEFAULT_WAIVER_SIGNED_CUSTOMER,
                'name' => 'Waiver Signed (Customer)',
                'description' => 'Sent after a waiver is completed.',
                'trigger_type' => SmsNotification::TRIGGER_WAIVER_SIGNED,
                'entity_type' => SmsNotification::ENTITY_WAIVER,
                'entity_ids' => [],
                'recipient_types' => [$C],
                'custom_phones' => [],
                'body' => '{{company_name}}: your waiver is complete. You\'re all set for {{location_name}}. See you soon!',
            ],
            [
                'default_key' => SmsNotification::DEFAULT_WAIVER_BULK_CHAPERONE,
                'name' => 'Bulk Waiver Invite (Chaperone)',
                'description' => 'Sent to a group organizer/chaperone to manage and send group waivers.',
                'trigger_type' => SmsNotification::TRIGGER_WAIVER_BULK_CHAPERONE,
                'entity_type' => SmsNotification::ENTITY_WAIVER,
                'entity_ids' => [],
                'recipient_types' => [$C],
                'custom_phones' => [],
                'body' => '{{company_name}}: your group needs waivers completed. Add contacts and track completion here: {{waiver_link}}',
            ],
            [
                'default_key' => SmsNotification::DEFAULT_WAIVER_PARENT_INVITE,
                'name' => 'Waiver Invite (Parent/Guardian)',
                'description' => 'Sent to a parent/guardian to complete a waiver for their minor(s).',
                'trigger_type' => SmsNotification::TRIGGER_WAIVER_PARENT_INVITE,
                'entity_type' => SmsNotification::ENTITY_WAIVER,
                'entity_ids' => [],
                'recipient_types' => [$C],
                'custom_phones' => [],
                'body' => '{{company_name}}: please complete a waiver for your group visit to {{location_name}}: {{waiver_link}}',
            ],
        ];
    }
}
